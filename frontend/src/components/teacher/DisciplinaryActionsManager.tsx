...
interface DisciplinaryActionsManagerProps {
  userRole?: 'teacher' | 'admin';
}

const DisciplinaryActionsManager: React.FC<DisciplinaryActionsManagerProps> = () => {
  ...
  const handleResolve = async () => {
    ...
    try {
      const response = await teacherApi.resolveDisciplinaryAction(selectedAction.id, {
  ...
  const handleAddComment = async () => {
    ...
    try {
      const response = await teacherApi.addDisciplinaryActionComment(selectedAction.id, {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600">Manage and track disciplinary actions</p>
        </div>
      </div>
...
export default DisciplinaryActionsManager;