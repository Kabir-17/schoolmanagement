...
const getEventById = async (id: string, schoolId: Types.ObjectId): Promise<any> => {
...
const deleteEvent = async (id: string, schoolId: Types.ObjectId, userId: Types.ObjectId): Promise<void> => {
  const event = await Event.findOne({ _id: id, schoolId });
